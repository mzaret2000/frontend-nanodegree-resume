...
contacts.contactWrap = function(id) {
...
bio.display = function() {
	...
	contacts.contactWrap("#topContacts");
...
education.display = function() {
	for (var univ in education.schools) {
...
bio.display();
education.display();
contacts.contactWrap("#footerContacts");
